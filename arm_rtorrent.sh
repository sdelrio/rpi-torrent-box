...
if docker pull $IMAGE ; then
    ...
    make rtorrent VER_RTORRENT=$VER_RTORRENT VER_LIBTORRENT=$VER_LIBTORRENT CURL_VERSION=$CURL_VERSION PACK_IMAGENAME=sdelrio/rpi-torrent-box BUILDER_BASE=$BUILDER_BASE GCCBUILDER_IMAGENAME=sdelrio/rpi-gccbuilder
